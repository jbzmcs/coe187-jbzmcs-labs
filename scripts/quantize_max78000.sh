...
LOG_DIRECTORY="../ai8x-training/logs/2025.11.09-035556"

# Quantization for cats and dogs
python quantize.py $LOG_DIRECTORY/checkpoint.pth.tar $LOG_DIRECTORY/qat_best-quantized.pth.tar --device MAX78000 -v "$@"
